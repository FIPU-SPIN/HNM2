...
export default function InventarPage() {
  ...
  // Funkcija za reprodukciju zvuka sa zaustavljanjem prethodnog
    ...
    <main className="bodydruga">
      ...
      <div className="inventar-sadrzaj">
        ...
        <div className="inventar-tablica">
          ...
          <table>
            <thead>
              <tr><th></th><th colSpan={2}>Naglašeni slog</th><th colSpan={2}>Nenaglašeni slogovi</th></tr>
              <tr><th>Naglasci</th><th>Kratki</th><th>Dugi</th><th>Kratki</th><th>Zanaglasni dugi</th></tr>
            </thead>
            <tbody>
              <tr><td>Silazni</td><td className="zvuk-link" data-zvuk="z1_ks">ȁ</td><td className="zvuk-link" data-zvuk="z2_ds">ȃ</td><td>ă</td><td>ā</td></tr>
              <tr><td>Uzlazni</td><td className="zvuk-link" data-zvuk="z4_ku">à</td><td className="zvuk-link" data-zvuk="z3_du">á</td><td></td><td></td></tr>
            </tbody>
          </table>
        ...
        <div className="ostali-prozodemi">
          ...
          <div className="prozodemi-tablica">
            ...
            <table>
              <thead><tr><th>Prozodem</th><th>Znak</th><th>Primjeri</th><th>Zvuk</th></tr></thead>
              <tbody>
        ...
        <div className="biljezenje-naglasaka">
          ...
          <div className="zrcola-slika-container">
            <Image src="/assets/images/Picture2.png" alt="ZRCola font naslovnica mrežne stranice" width={600} height={400} className="zrcola-slika" />
        ...
        <div className="fonetska-analiza">
          ...
          <div className="praat-sekcija">
            <p className="napomena-za-zvuk">
              ...
              <br />
              <button className="zvuk-gumb praat-zvuk-gumb" data-zvuk="zvuk-1-2-1" onClick={() => playSound("zvuk-1-2-1")}>🔊 Poslušaj izgovor</button>
            </p>
