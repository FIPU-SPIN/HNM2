      ...
      <div className="inventar-sadrzaj">
        ...
        <div className="inventar-intro">
          ...
          <p className="napomena-za-zvuk">
            <strong>PLACEHOLDER! Poslušajte kako zvuče u riječima klikom na naglašeni vokal.</strong>
          </p>
        </div>
        ...
        <div className="inventar-tablica">
          ...
          <p className="tablica-napomena">
            <em>PLACEHOLDER Zvuk 1-2-2 - klikom na označene znakove (ȁ, ȃ, à, á) čujete izgovor</em>
          </p>
        </div>
        ...
        <div className="ostali-prozodemi">
          ...
          <p className="napomena-za-zvuk">
            <em>PLACEHOLDER Zvuk 1-2-3 - klikom na znakove ili gumbe čujete primjere</em>
          </p>
        </div>
