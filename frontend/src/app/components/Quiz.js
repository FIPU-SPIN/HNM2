...
export default function Quiz({ steps, onSubmit }) {
 ...
 const handleFinish = async () => {
  try {
    ...
    if (!res.ok) {
      ...
      throw new Error(errorData.message || "Greška pri spremanju kviza");
    }

    const data = await res.json();
    console.log("Spremljeno:", data);
      ...
      <div className="quiz-card">
        ...
        {current.type === "intro" && (
          <>
            ...
            {current.image && (
              <Image
                src="/assets/images/karta-narjecja.png"
                width={600}
                height={500}
                alt="intro"
